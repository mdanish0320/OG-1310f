...
$("<div id='black_window1'></div>").appendTo('body'); //creating element div of left side
$("<div id='new_pic_div'></div>").appendTo('#black_window1'); //creating element div conating pic of left side
...
$("<div id='right_div'></div>").appendTo('#black_window2');// creating element div of right side
$("<div id='des_div'></div>").appendTo('#right_div'); 		// creatring elemtn div of right side containing table
...
$("<a id='download' href='#'>Download </a>").appendTo('#download_div'); //creating anchor element name download
...
folder1 = $('body').data('path1');		// getting path stored in body element for downloading word file
folder2 = $('body').data('path2');		// getting path stored in body element for downloading word file

$(this).attr('href','word_file/' +folder1 +'/' +folder2+ '/'+  folder1+'_'+folder2  +c+'.docx'); //giving path of word file to anchor element name download
...
new_para=$('.danish')[c-1].getAttribute('data-para');
...
$('#pic'+c).css('opacity','0').css('width',pic_width[c-1]).css('height',pic_height[c-1]).css('z-index','2').css('position','relative').css('left','-1px').css('top','0px');
